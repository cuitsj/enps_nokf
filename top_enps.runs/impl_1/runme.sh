...
HD_PWD='G:/VC707/top_enps/top_enps/top_enps.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_enps.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_enps.tcl -notrace
