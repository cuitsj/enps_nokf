...
HD_PWD='G:/VC707/top_enps/top_enps/top_enps.runs/ila_top_enps_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_top_enps.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_top_enps.tcl
