...
HD_PWD='G:/VC707/top_enps/top_enps/top_enps.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_enps.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_enps.tcl
