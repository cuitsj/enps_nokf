...
#
# Generated by export_simulation on Tue Apr 05 16:28:56 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './ila_top_enps.sh' script.

./ila_top_enps.sh -reset_run
...
./ila_top_enps.sh -noclean_files

For more information on the script, please type './ila_top_enps.sh -help'.
